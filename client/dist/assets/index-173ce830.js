...
`,Q2=[{title:"Home",link:"/"},{title:"Forum",link:"/forums"},{title:"Classes",link:"/classes"},{title:"Requests",link:"/requests"},{title:"Profile",link:"/me"}],Xt=()=>v(Y2,{children:[v(W2,{children:[l(H2,{children:l("img",{src:t1,alt:"tnl_logo"})}),l(m1,{})]}),l(V2,{children:Q2.map((e,t)=>l(G2,{children:l(ni,{to:e.link,children:l("span",{children:e.title})})},t))})]}),q2="/assets/home-intro-img-c5a56783.png",K2=m.div`
...
`,HC=m.div`
  ...
  line-height: 19px;
  color: #ffffff;
`,VC=e=>{const t=Ge();return v($C,{onClick:()=>{Jn(),t(`/learncard-overview/${e._id}`,{state:{learnCardId:e._id,backLink:"/"}})},children:[l(UC,{children:l("h4",{children:e.subject})}),l(BC,{children:l("span",{children:e.topic})}),l(WC,{children:l(Pn,{name:e.createdBy.name,photo:e.createdBy.photo,imgBorder:"#FFFFFF",textColor:"#FFFFFF"})}),v(YC,{children:[v("div",{children:[l(As,{}),v("span",{children:[e.interestedStudents.length," Interested"]})]}),l(HC,{children:v("span",{children:["Due - ",Dr(e.dueDate)]})})]})]})},GC=m.div`
  /* border: 1px solid red; */
  display: flex;
  flex-direction: column;
  gap: 2rem;
...
`,ok={desktop:{breakpoint:{max:3e3,min:1024},items:3,slidesToSlide:1},tablet:{breakpoint:{max:1024,min:464},items:2,slidesToSlide:2},mobile:{breakpoint:{max:464,min:0},items:1,slidesToSlide:1}},sk=[{iframe:l("iframe",{src:"https://www.youtube.com/embed/9Rg4NKwCsZw",title:"YouTube video player",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",allowFullScreen:!0}),text:"The Feynman Technique of Learning Anything"},{iframe:l("iframe",{width:"560",height:"315",src:"https://www.youtube.com/embed/9Rg4NKwCsZw",title:"YouTube video player",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",allowFullScreen:!0}),text:"The Feynman Technique of Learning Anything"},{iframe:l("iframe",{width:"560",height:"315",src:"https://www.youtube.com/embed/9Rg4NKwCsZw",title:"YouTube video player",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",allowFullScreen:!0}),text:"The Feynman Technique of Learning Anything"},{iframe:l("iframe",{width:"560",height:"315",src:"https://www.youtube.com/embed/9Rg4NKwCsZw",title:"YouTube video player",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",allowFullScreen:!0}),text:"The Feynman Technique of Learning Anything"},{iframe:l("iframe",{width:"560",height:"315",src:"https://www.youtube.com/embed/9Rg4NKwCsZw",title:"YouTube video player",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",allowFullScreen:!0}),text:"The Feynman Technique of Learning Anything"}],ak=sk.map((e,t)=>v(rk,{children:[e.iframe,l(ik,{children:e.text})]})),B1=()=>v(nk,{children:[l("h3",{children:"Browse through our youtube videos"}),l(tk,{responsive:ok,children:ak}),";"]}),lk=m.div`
  ...
  flex-direction: column;
  gap: 2.5rem;
`,uk=()=>{const[e,t]=S.useState(""),[n,r]=S.useState(""),[i,o]=S.useState(""),[s,a]=S.useState(),[u,c]=S.useState(),[d,f]=S.useState(),{fetchLocalUserData:h}=kt(),w=Ge();S.useEffect(()=>{h().then(y=>{t(y.token),o(y._id),r(y.role)}).catch(()=>{w("/teachNlearn")})},[]);async function g(){await le.get(`${ue}${ce}/teach`,{params:{sort:"classStartsAt"},headers:Ce(e??"")}).then(({data:y})=>{console.log(y.teachCards),c(y.teachCards)})}async function A(){await le.get(`${ue}${ce}/user/myclasses/upcoming`,{headers:Ce(e??"")}).then(({data:y})=>{const p=y.upcomingClasses;console.log(p),a(p)})}const b=async()=>{await le.get(`${ue}${ce}/learn`).then(({data:y})=>{console.log(y.data.data);const p=y.data.data;f(p)})};return S.useEffect(()=>{e&&(g(),A(),b())},[e]),v(Ae,{children:[l(Xt,{}),v(lk,{children:[l(jf,{role:n}),u&&u.length!=0&&l(f5,{heading:"Classes recommended for you!",cardArr:u,userId:i}),s&&s.length!=0&&l(jC,{heading:"Upcoming Enrolled Classes!",cardArr:s}),d&&l(XC,{heading:"Rising Requests",requestCard:d}),l(B1,{}),l(m5,{}),l(Xl,{})]})]})},ck=m.div`
...
`,eh=e=>l(ck,{onClick:e.onClickFunc,children:v("div",{children:[l("span",{children:"Edit"}),l(E2,{})]})});var nl={},dk={get exports(){return nl},set exports(e){nl=e}},ri={},rl={},fk={get exports(){return rl},set exports(e){rl=e}},hk="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED",pk=hk,mk=pk;function Y1(){}function W1(){}W1.resetWarningCache=Y1;var gk=function(){function e(r,i,o,s,a,u){if(u!==mk){var c=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw c.name="Invariant Violation",c}}e.isRequired=e;function t(){return e}var n={array:e,bigint:e,bool:e,func:e,number:e,object:e,string:e,symbol:e,any:e,arrayOf:t,element:e,elementType:e,instanceOf:t,node:e,objectOf:t,oneOf:t,oneOfType:t,shape:t,exact:t,checkPropTypes:W1,resetWarningCache:Y1};return n.PropTypes=n,n};fk.exports=gk();var il={},yk={get exports(){return il},set exports(e){il=e}},gn={},as={},vk={get exports(){return as},set exports(e){as=e}};(function(e,t){Object.defineProperty(t,"__esModule",{value:!0}),t.default=d;/*!
...
`,Bb=m.div`
  ...
  font-size: 20px;
  line-height: 30px;
`,Yb=[{option:"My profile",label:"MyProfile",icon:l(b2,{})}],Wb=({setSelectedLeftScreen:e})=>{const[t,n]=S.useState("MyProfile"),r=i=>{n(i),e(i)};return v($b,{children:[l(Ub,{children:Yb.map((i,o)=>v(Bb,{isSelected:t==i.label,onClick:()=>r(i.label),children:[i.icon,l("span",{children:i.option})]},o))}),l(jb,{})]})},Hb=m.div`
  display: flex;
  flex-direction: row;
  /* justify-content: space-between; */
  align-items: center;
...
`,qb=m.span`
  ...
  font-size: 18px;
  line-height: 25px;
`,Kb=e=>{const[t,n]=S.useState(e.role),r=async()=>{t=="learn"?(await le.patch(`${ue}${ce}/user/myMode`,{mode:"teach"},{headers:Ce(e.userToken??"")}).then(({data:i})=>{const o=i.updatedUser;o.token=e.userToken,console.log(o),localStorage.setItem(Hn,JSON.stringify(o))}),n("teach")):(await le.patch(`${ue}${ce}/user/myMode`,{mode:"learn"},{headers:Ce(e.userToken??"")}).then(({data:i})=>{const o=i.updatedUser;o.token=e.userToken,console.log(o),localStorage.setItem(Hn,JSON.stringify(o))}),n("learn"))};return v(Hb,{children:[l(Qb,{isChecked:t=="learn",children:"Teach Mode"}),v(Gb,{children:[l("input",{type:"checkbox",checked:t=="learn",onClick:r}),l(Vb,{className:"slider",isChecked:t=="learn"})]}),l(qb,{isChecked:t=="learn",children:"Learn Mode"})]})},X1=m.div`
  position: relative;
  width: 100%;
  height: 20px;
  margin-bottom: 2rem;
...
`,R3=m.div`
  ...
  /* width: /1; */
`,L3=()=>{const[e,t]=S.useState("MyProfile");S.useEffect(()=>{console.log(e),e=="MyProfile"&&r(l(Cm,{}))},[e]);const[n,r]=S.useState(l(Cm,{}));return v(Ae,{children:[l(Xt,{}),v(D3,{children:[l(Wb,{setSelectedLeftScreen:t}),l(R3,{children:n})]})]})},I3=m.div`
...
`,Lo=m.div`
  ...
  flex-direction: column;
  gap: 8px;
`,W3=e=>l(Y3,{children:v("form",{action:"",children:[l(rh,{updateFields:e.updateFields}),l(_e,{type:"text",label:"Phone Number",value:e.number,name:"number",updateFields:e.updateFields}),l(_e,{type:"text",label:"Course Enrolled",value:e.course,name:"course",updateFields:e.updateFields}),v(Lo,{children:[l(Tr,{label:"Interested Subjects (Max 5)",value:e.interestedSubject,name:"interestedSubjects",elemName:"interestedSubject",updateFields:e.updateFields,arr:e.interestedSubjects}),e.interestedSubjects.length!=0?l(Or,{listArr:e.interestedSubjects,updateFields:e.updateFields,name:"interestedSubjects"}):null]}),v(Lo,{children:[l(Tr,{label:"Strong Subjects",value:e.strongSubject,elemName:"strongSubject",name:"strongSubjects",updateFields:e.updateFields,arr:e.strongSubjects}),e.strongSubjects.length!=0?l(Or,{listArr:e.strongSubjects,updateFields:e.updateFields,name:"strongSubjects"}):null]}),v(Lo,{children:[l(Tr,{label:"Preferred Languages",value:e.language,elemName:"language",name:"preferredLanguages",updateFields:e.updateFields,arr:e.preferredLanguages}),e.preferredLanguages.length!=0?l(Or,{listArr:e.preferredLanguages,updateFields:e.updateFields,name:"preferredLanguages"}):null]})]})}),H3=m.div`
  /* border: 1px solid red; */
  display: flex;
  align-items: center;
  justify-content: center;
...
`,V3=e=>v(H3,{index:e.index,children:[l("div",{className:"first"}),l("div",{className:"second"})]}),G3=m.div`
  display: flex;
  box-sizing: border-box;
  align-items: center;
  justify-content: center;
...
`,B8=()=>{const[e,t]=S.useState({email:"",password:""});function n(s){t(a=>({...a,...s}))}const r=Ge(),i=s=>{Jn(),r(s)},o=async s=>{s.preventDefault();const{data:a}=await le.post(`${ue}${ce}/auth/login`,{email:e.email,password:e.password});a.status==="success"&&(a.data.user.token=a.token,localStorage.setItem(Hn,JSON.stringify(a.data.user)),i("/"))};return v(F8,{children:[l(z8,{children:v($8,{children:[l(I8,{...e,updateFields:n}),l(U8,{children:l("button",{type:"submit",onClick:o,children:"Login"})}),v("span",{className:"login",children:["Don't have an account?"," ",l("span",{className:"link",onClick:()=>i("/signup"),children:"Sign Up!!"})," "]})]})}),l(j8,{children:l(J1,{heading:"Welcome Back!!"})})]})},Y8=m.div`
  border: 1px solid red;
